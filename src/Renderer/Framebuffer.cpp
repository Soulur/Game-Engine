...
namespace Mc
{
    ...
    namespace Utils
    {
        ...
        static void AttachDepthDirShadowTexture(uint32_t id, int samples, GLenum format, GLenum attachmentType, uint32_t width, uint32_t height)
        {
            bool multisampled = samples > 1;
            if (multisampled)
            {
        ...
        static bool IsDepthFormat(FramebufferTextureFormat format)
        {
            ...
            case FramebufferTextureFormat::DEPTH24STENCIL8:
                return true;
            case FramebufferTextureFormat::DIRSHADOW:
                return true;
            }
    ...
    void Framebuffer::Invalidate()
    {
        ...
        if (m_DepthAttachmentSpecification.TextureFormat != FramebufferTextureFormat::None)
        {
            ...
            case FramebufferTextureFormat::DEPTH24STENCIL8:
                ...
                break;
            case FramebufferTextureFormat::DIRSHADOW:
                Utils::AttachDepthDirShadowTexture(m_DepthAttachment, m_Specification.Samples, GL_DEPTH_COMPONENT, GL_DEPTH_ATTACHMENT, m_Specification.Width, m_Specification.Height);
                break;
            }
        }
    ...
    void Framebuffer::BindDepthAttachment(int slot)
    {
